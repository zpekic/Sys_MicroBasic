...
9001 push d, v, h
9002 for d=0 to 7
9010 	push v%16: let v=v/16
9020 next d
9025 for d=0 to 7
9030 	pop v
9035 	if v>9 then let h=usr(28,55+v,0)
9040 	if v<10 then let h=usr(28,48+v,0)
9090 next d
9091 print " ",
9095 pop h, v, d: return

9100 rem print var v as decoded Am9511 floating point format
9105 gosub 9200
9110 push s: let s=50000000: gosub 9300
