...
105 REM   SW210    Am9080 (MHz) Result (s)	Basic CPU
106 REM   100     01.5625 52m23   3143		--
107 REM   101     03.1250 26m12   1572		--
108 REM   110     06.2500 13m06   786		146.803
109 REM   111     25.0000 3m17    197		37.47			
110 REM   -------------------------------------
111 REM   Note: combining 310 and 312 into one statement with LET speeds up 10%!
130 PRINT "Starting."
140 FOR N = 1 TO 1000
150 	GOSUB 300
240 NEXT N
