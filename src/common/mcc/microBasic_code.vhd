...
--
-- L0018.seq_cond: .if 4 values true, CHAROUT_BIT7, CHAROUT_READY, IL_PC_VALID, DBG_READY, MDR_EQU_DB, nBUSACK, INLEND_MAX, INLEND_MIN, CHARIN_PRINTABLE, CHARIN_EQU_DB, CHARIN_READY, BP_IN_INPLINE, SVP_IN_INPLINE, dummy_E, false default true;
--
...
--
-- L0125.gotChar: .valfield 1 values 0, 1 default 0;
--
alias mb_gotChar: 	std_logic is mb_uinstruction(10);
-- Value '0' allowed
-- Value '1' allowed
---- Start boilerplate code (use with utmost caution!)
--  gotChar <= mb_gotChar;
...
--
-- L0131.dummy: .valfield 10 values * default 0;
--
alias mb_dummy: 	std_logic_vector(9 downto 0) is mb_uinstruction(9 downto 0);
-- Values from "0000000000" to "1111111111" allowed
---- Start boilerplate code (use with utmost caution!)
--  dummy <= mb_dummy;
---- End boilerplate code
...
-- nop;
-- L0164@0000 E000007F80000000._reset:  if true then next;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
0 => '1' & '1' & '1' & X"0" & O"000" & O"000" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- nop;
-- L0166@0001 E000007F80000000._reset1:  if true then next;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
1 => '1' & '1' & '1' & X"0" & O"000" & O"000" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- nop;
-- L0168@0002 E000007F80000000._reset2:  if true then next;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
2 => '1' & '1' & '1' & X"0" & O"000" & O"000" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- nop;
-- L0170@0003 E000007F80000000._reset3:  if true then next;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
3 => '1' & '1' & '1' & X"0" & O"000" & O"000" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- clear;
-- L0174@0004 E000007F9100A800.WarmStart:  DBGINDEX <= zero, IL_PC <= zero, BP <= InLine_start, SvPt <= InLine_start, InlEnd <= InLine_start;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 10, IL_PC <= 001, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 01, BP <= 01, SvPt <= 01, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 010, IL_OP <= 1, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
10 => '1' & '1' & '1' & X"0" & O"000" & O"000" & X"FF" & "00" & "00" & O"2" & '1' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- if true then fork else fork;
-- L0182@000B E00301FF80000000.  if true then fork else fork;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000011 else 000000011, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1111) then 000000000 else 000000100, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1100) then 000000000 else 000010110, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
18 => '1' & '1' & '1' & X"C" & O"000" & O"026" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- SvPt <= BP, goto fetch;
-- L0197@0013 FE0003FF80001000.save_bp:  SvPt <= BP, if false then next else fetch;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1111) then 000000000 else 000000111, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 10, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1101) then 000010011 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
21 => '1' & '1' & '1' & X"D" & O"023" & O"000" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- SvPt <= BP, BP <= SvPt, goto fetch;
-- L0202@0016 FE0003FF80005000.ptr_exc:  SvPt <= BP, BP <= SvPt, if false then next else fetch;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1111) then 000000000 else 000000111, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 10, SvPt <= 10, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0001) then 000000000 else 000011011, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 010, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
29 => '1' & '1' & '1' & X"1" & O"000" & O"033" & X"FF" & "00" & "00" & O"2" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- goto fetch;
-- L0214@001E FE0003FF80000000.pc_exit:  if false then next else fetch;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1111) then 000000000 else 000000111, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0000) then 000000000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 01, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
32 => '1' & '1' & '1' & X"0" & O"000" & O"000" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "01" & "00" & "00" & '0' & "0000000000",

-- if CHARIN_READY then next else repeat;
-- L0219@0021 F60000FF80000000.gl_loop:  if CHARIN_READY then next else repeat;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1011) then 000000000 else 000000001, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
33 => '1' & '1' & '1' & X"B" & O"000" & O"001" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '0' & "0000000000",

-- if CHARIN_PRINTABLE then gl_print;
-- L0220@0022 F228007F80000000.  if CHARIN_PRINTABLE then gl_print;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1001) then 000101000 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1010) then 000110001 else 000000000, directByte = 00001000, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1111) then 000000000 else 000100001, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 1, dummy = 0000000000;
39 => '1' & '1' & '1' & X"F" & O"000" & O"041" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '1' & "0000000000",

-- if INLEND_MAX then gl_ignore;
-- L0229@0028 EE26007F80000000.gl_print:  if INLEND_MAX then gl_ignore;
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (0111) then 000100110 else 000000000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 0, dummy = 0000000000;
...
--  nBUSREQ = 1, nWR = 1, nRD = 1, if (1111) then 000000000 else 000100000, directByte = 11111111, T <= 00, DBGINDEX <= 00, IL_PC <= 000, IL_OP <= 0, CHAROUT <= 00, MAR <= 00, MDR <= 00, InlEnd <= 00, BP <= 00, SvPt <= 00, gotChar = 1, dummy = 0000000000;
48 => '1' & '1' & '1' & X"F" & O"000" & O"040" & X"FF" & "00" & "00" & O"0" & '0' & "00" & "00" & "00" & "00" & "00" & "00" & '1' & "0000000000",

-- if INLEND_MIN then gl_ignore;
-- L0240@0031 F026007F80000000.gl_bs:  if INLEND_MIN then gl_ignore;
