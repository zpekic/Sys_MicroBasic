...
-- traceString 4;
-- L0359@0004 C1D3E984020000000000.ColdStart:  trace(from_microcode), directByte = 4;
...
-- L0360@0005 C19BCDFF700000000000.  write2Nulls(Prog_start);
...
-- L0363@0008 C19BCDFF68C000000020.  Lino <= T, IL_PC <= T, write2Nulls(BP);
...
-- traceString 51;
-- L0365@0009 C1D3E9B3020000000000.fetch:  trace(from_microcode), directByte = 51;
...
-- traceString 2;
-- L0366@000A C1D3E982020000000000.fetch1:  trace(from_microcode), directByte = 2;
...
-- L0367@000B C1D3E9B8029000000000.  IL_OP <= from_interpreter, IL_PC <= inc, trace(from_microcode), directByte = 56;
...
-- L0368@000C C603BCFF380000000040.  T <= zero, alu <= reset0, if IL_A_VALID then fork else INTERNAL_ERR;
...
-- goto INTERNAL_ERR;
-- L0371@000D FE00BCFF000000000000.badop:  if false then continue else INTERNAL_ERR;
...
-- traceString 15;
-- L0376@000E C1D3E98F020000000000.  trace(from_microcode), directByte = 15;
...
-- L0377@000F C1D3E9B3020040000000.  ExpStack <= startSwap, trace(from_microcode), directByte = 51;
...
-- traceString 15;
-- L0381@0011 C1D3E98F020000000000.  trace(from_microcode), directByte = 15;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0001111, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 12;
-- L0387@0013 C1D3E98C020000000000.  trace(from_microcode), directByte = 12;
...
-- traceString 28;
-- L0393@0015 C1D3E99C020000000000.  trace(from_microcode), directByte = 28;
...
-- L0394@0016 C1D3E983420000000000.lb_push:  trace(from_microcode), directByte = 3, T <= codeByte;
...
-- L0396@0018 E17B04FF008000000000.  IL_PC <= inc, if STACK_IS_FULL then ESTACK_ERR else fetch;
...
-- traceString 29;
-- L0401@0019 C1D3E99D020000000000.  trace(from_microcode), directByte = 29;
...
-- traceString 3, T <= codeByte;
-- L0402@001A C1D3E983420000000000.  trace(from_microcode), directByte = 3, T <= codeByte;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0000011, T <= 01000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0404@001C E17B0B7F008000000000.  IL_PC <= inc, if STACK_IS_FULL then ESTACK_ERR else lb_push;
...
-- traceString 38;
-- L0409@001D C1D3E9A6020000000000.  trace(from_microcode), directByte = 38;
...
-- L0410@001E E37B007F000000000000.  if STACK_IS_EMPTY then ESTACK_ERR;
...
-- L0411@001F E17B007F200000000000.  T <= ExpStack, if STACK_IS_FULL then ESTACK_ERR;
...
-- traceString 34;
-- L0417@0021 C1D3E9A2020000000000.  trace(from_microcode), directByte = 34;
...
-- if STACK_IS_EMPTY then ESTACK_ERR;
-- L0418@0022 E37B007F000000000000.  if STACK_IS_EMPTY then ESTACK_ERR;
--  nWR = 1, nRD = 1, if (10001) then 101111011 else 000000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 10;
-- L0424@0024 C1D3E98A020000000000.  trace(from_microcode), directByte = 10;
...
-- traceBP();
-- L0427@0027 C1C6E37F000000000000.bp_done:  traceBP();
...
-- traceString 11;
-- L0433@0029 C1D3E98B020000000000.  trace(from_microcode), directByte = 11;
...
-- traceString 36;
-- L0440@002C C1D3E9A4020000000000.  trace(from_microcode), directByte = 36;
...
-- L0441@002D E37B007F000000000800.  Vars <= indexFromExpStack, if STACK_IS_EMPTY then ESTACK_ERR;
...
-- L0442@002E C1D3E9B31A00E0000000.  T <= from_vars, ExpStack <= pop1, trace(from_microcode), directByte = 51;
...
-- traceString 37;
-- L0448@0030 C1D3E9A5020000000000.  trace(from_microcode), directByte = 37;
...
-- if STACK_IS_EMPTY then ESTACK_ERR;
-- L0449@0031 E37B007F000000000000.  if STACK_IS_EMPTY then ESTACK_ERR;
--  nWR = 1, nRD = 1, if (10001) then 101111011 else 000000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- Vars <= indexFromExpStack, if STACK_IS_EMPTY then ESTACK_ERR;
-- L0451@0033 E37B007F000000000800.  Vars <= indexFromExpStack, if STACK_IS_EMPTY then ESTACK_ERR;
--  nWR = 1, nRD = 1, if (10001) then 101111011 else 000000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 01, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 47;
-- L0457@0035 C1D3E9AF020000000000.  trace(from_microcode), directByte = 47;
...
-- L0458@0036 F600BCFF000000000000.  if IS_RUNMODE then next else INTERNAL_ERR;
...
-- L0459@0037 E17F007F000000000000.  if STACK_IS_FULL then BSTACK_ERR;
...
-- traceString 48;
-- L0465@0039 C1D3E9B0020000000000.  trace(from_microcode), directByte = 48;
...
-- if IS_RUNMODE then next else INTERNAL_ERR;
-- L0466@003A F600BCFF000000000000.  if IS_RUNMODE then next else INTERNAL_ERR;
--  nWR = 1, nRD = 1, if (11011) then 000000000 else 101111001, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0467@003B E37F007FA00000000000.  T <= BasStack_Hi,if STACK_IS_EMPTY then BSTACK_ERR;
...
-- L0468@003C C1D3E9B3AA0000000020.  Lino <= T, T <= BasStack_Lo, trace(from_microcode), directByte = 51;
...
-- traceString 45;
-- L0474@003E C1D3E9AD020000000000.  trace(from_microcode), directByte = 45;
...
-- L0475@003F E37B007F004000000000.  IL_PC <= XQhere, if STACK_IS_EMPTY then ESTACK_ERR;
...
-- L0478@0042 E771007F000000000020.  Lino <= T, if R_IS_ZERO then NOPROG_ERR;
...
-- L0493@004A C1BDDEFF000003000080.findLino:  alu <= reset1, readCore(T);
...
-- L0495@004C C1BDDEFF000003000500.  alu <= S_fromLino, readCore(T);
...
-- findNextCR(same);
-- L0499@0050 C194CA7F000000000000.  findNextCR(same);
...
-- traceString 25;
-- L0505@0052 C1D3E999020000000000.  trace(from_microcode), directByte = 25;
...
-- L0506@0053 E37B007F0000000000C0.  alu <= R_fromStack, if STACK_IS_EMPTY then ESTACK_ERR;
...
-- traceString 22;
-- L0513@0056 C1D3E996020000000000.  trace(from_microcode), directByte = 22;
...
-- pullRS();
-- L0514@0057 C19ECF7F000000000000.  pullRS();
...
-- traceALU();
-- L0516@0059 C1CCE67F000000000000.alu_done:  traceALU();
...
-- L0517@005A EF75007F280000000000.  T <= from_YLo, if ALU_OVERFLOW then OVERFLOW_ERR;
...
-- traceString 23;
-- L0523@005C C1D3E997020000000000.  trace(from_microcode), directByte = 23;
...
-- pullRS();
-- L0524@005D C19ECF7F000000000000.  pullRS();
--  nWR = 1, nRD = 1, if (00000) then 110011110 else 110011110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 24;
-- L0530@005F C1D3E998020000000000.  trace(from_microcode), directByte = 24;
...
-- pullRS();
-- L0531@0060 C19ECF7F000000000000.  pullRS();
--  nWR = 1, nRD = 1, if (00000) then 110011110 else 110011110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 35;
-- L0537@0062 C1D3E9A3020000000000.  trace(from_microcode), directByte = 35;
...
-- pullRS();
-- L0538@0063 C19ECF7F000000000000.  pullRS();
--  nWR = 1, nRD = 1, if (00000) then 110011110 else 110011110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0539@0064 E773007F000000000300.  alu <= div_start, if R_IS_ZERO then DIVBY0_ERR;
...
-- traceString 46;
-- L0548@0069 C1D3E9AE020000000000.  trace(from_microcode), directByte = 46;
...
-- traceString 39;
-- L0559@0070 C1D3E9A7020000000000.  trace(from_microcode), directByte = 39;
...
-- findNextCR(BP);
-- L0562@0072 C194CA7F680000000000.  findNextCR(BP);
...
-- readCore16(BP);
-- L0565@0075 C197CBFF680000000000.  readCore16(BP);
...
-- traceBP();
-- L0569@0078 C1C6E37F000000000000.  traceBP();
--  nWR = 1, nRD = 1, if (00000) then 111000110 else 111000110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0570@0079 C96B04FF000000000000.  if KBD_BREAK then BREAK else fetch;
...
-- L0571@007A C1BADD07000008000000.nx_err:  directByte = 0x07, outChar(from_microcode);
...
-- traceString 41;
-- L0577@007C C1D3E9A9020000000000.  trace(from_microcode), directByte = 41;
...
-- L0583@0082 EC00BBFF000000000000.  if LS_PARAMS_OK then next else SYNTAX_ERR;
...
-- L0586@0085 C96B007F000000000000.  if KBD_BREAK then BREAK;
...
-- L0590@0089 C197CBFF000000002000.ls_continue:  gotChar = 1, readCore16(same);
...
-- printDecR(Y_save);
-- L0594@008D C1A3D1FF000000000680.  printDecR(Y_save);
...
-- L0595@008E C1BADD200000080006C0.  alu <= Y_recall, directByte = ' ', outChar(from_microcode);
...
-- readCore(T);
-- L0596@008F C1BDDEFF000003000000.ls_charloop:  readCore(T);
...
-- outChar(from_MDR);
-- L0597@0090 C1BADD7F000010000000.  outChar(from_MDR);
...
-- L0599@0092 C1BADD0A000008000000.  directByte = 0x0A, outChar(from_microcode);
...
-- findNextCR(same);
-- L0602@0095 C194CA7F000000000000.ls_nextLine:  findNextCR(same);
--  nWR = 1, nRD = 1, if (00000) then 110010100 else 110010100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 26;
-- L0608@0097 C1D3E99A020000000000.  trace(from_microcode), directByte = 26;
...
-- if STACK_IS_EMPTY then ESTACK_ERR;
-- L0609@0098 E37B007F000000000000.  if STACK_IS_EMPTY then ESTACK_ERR;
--  nWR = 1, nRD = 1, if (10001) then 101111011 else 000000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
152 => '1' & '1' & "10001" & O"573" & O"000" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- printDec();
-- L0610@0099 C1A2D17F000000000000.  printDec();
...
-- traceString 18;
-- L0616@009B C1D3E992020000000000.  trace(from_microcode), directByte = 18;
...
-- BP <= inc, readCore(BP);
-- L0617@009C C1BDDEFF000002030000.pq_loop:  BP <= inc, readCore(BP);
...
-- outChar(from_MDR);
-- L0619@009E C1BADD7F000010000000.  outChar(from_MDR);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 100, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
158 => '1' & '1' & "00000" & O"672" & O"672" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"4" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 3;
-- L0620@009F C1D3E983020000000000.  trace(from_microcode), directByte = 3;
...
-- L0621@00A0 CB794E0D000000000000.  directByte = 0x0D, if MDR_EQU_DB then INTERNAL_ERR else pq_loop;
...
-- traceBP();
-- L0622@00A1 C1C6E37F000000000000.pq_done:  traceBP();
--  nWR = 1, nRD = 1, if (00000) then 111000110 else 111000110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 27;
-- L0628@00A3 C1D3E99B020000000000.  trace(from_microcode), directByte = 27;
...
-- L0630@00A5 C1BADD20000008000000.  directByte = ' ', outChar(from_microcode);
...
-- traceString 6;
-- L0636@00A7 C1D3E986020000000000.  trace(from_microcode), directByte = 6;
...
-- outCRLF();
-- L0637@00A8 C1B8DC7F000000000000.crlf_fetch:  outCRLF();
...
-- traceString 5;
-- L0643@00AA C1D3E985020000000000.  trace(from_microcode), directByte = 5;
...
-- L0644@00AB C1BADD7F000004000000.pc_loop:  outChar(from_interpreter);
...
-- traceString 3;
-- L0645@00AC C1D3E983020000000000.  trace(from_microcode), directByte = 3;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0000011, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 8;
-- L0651@00AE C1D3E988020000000000.  trace(from_microcode), directByte = 8;
...
-- directByte = BEEP, outChar(from_microcode);
-- L0662@00B8 C1BADD07000008000000.gl_ignore:  directByte = 0x07, outChar(from_microcode);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 0000111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 010, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- outChar(from_charin);
-- L0666@00BB C1BADD7F00000C000000.  outChar(from_charin);
...
-- L0667@00BC C1BCDE7F000001700000.  writeCore(InlEnd, CHARIN), InlEnd <= inc;
...
-- L0668@00BD C1BCDE7F000001400000.gl_write0:  writeCore(InlEnd, zero);
...
-- directByte = BEEP, outChar(from_microcode);
-- L0671@00BF C1BADD07000008000000.gl_esc:  directByte = 0x07, outChar(from_microcode);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 0000111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 010, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
191 => '1' & '1' & "00000" & O"672" & O"672" & "0000111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"2" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- outCRLF();
-- L0672@00C0 C1B8DC7F000000000000.  outCRLF();
--  nWR = 1, nRD = 1, if (00000) then 110111000 else 110111000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0676@00C3 C1BADD08000008000000.  directByte = 0x08, outChar(from_microcode);
...
-- outCRLF();
-- L0682@00C8 C1B8DC7F000000000000.  outCRLF();
--  nWR = 1, nRD = 1, if (00000) then 110111000 else 110111000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- directByte = ' ', outChar(from_microcode);
-- L0687@00CC C1BADD20000008000000.  directByte = ' ', outChar(from_microcode);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 0100000, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 010, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0688@00CD C1BCDE20000001F00000.  directByte = ' ', writeCore(InlEnd, from_microcode), InlEnd <= inc;
...
-- traceString 40;
-- L0694@00CF C1D3E9A8020000000000.  trace(from_microcode), directByte = 40;
...
-- L0697@00D2 EB77007F280000000000.  T <= from_YLo, if Y_SIGN then SYNTAX_ERR;
...
-- L0698@00D3 E977007F000000000020.  Lino <= T, if Y_ZERO then SYNTAX_ERR;
...
-- BE <= T, readCore(T);
-- L0703@00D7 C1BDDEFF000003000010.il_findBE:  BE <= T, readCore(T);
...
-- write2Nulls(same);
-- L0729@00EC C19BCDFF000000000000.  write2Nulls(same);
...
-- L0733@00EF C1BCDE7F000003A00000.  writeCore(T, from_SHi);
...
-- L0735@00F1 C1BCDE7F000003C00000.  writeCore(T, from_SLo);
...
-- readCore(BP);
-- L0737@00F3 C1BDDEFF000002000000.app_loop:  readCore(BP);
...
-- writeCore(T, same);
-- L0738@00F4 C1BCDE7F000003000000.  writeCore(T, same);
...
-- readCore16(same);
-- L0743@00F8 C197CBFF000000000000.fpe_loop:  readCore16(same);
...
-- findNextCR(same);
-- L0747@00FC C194CA7F000000000000.fpe_next:  findNextCR(same);
--  nWR = 1, nRD = 1, if (00000) then 110010100 else 110010100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0755@0100 C197CBFF000000000008.scan_loop:  LS <= T, readCore16(same);
...
-- traceALU();
-- L0758@0103 C1CCE67F000000000000.  traceALU();
--  nWR = 1, nRD = 1, if (00000) then 111001100 else 111001100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- findNextCR(same);
-- L0761@0106 C194CA7F000000000000.scan_next:  findNextCR(same);
--  nWR = 1, nRD = 1, if (00000) then 110010100 else 110010100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- findNextCR(same);
-- L0764@0108 C194CA7F000000000000.scan_found:  findNextCR(same);
--  nWR = 1, nRD = 1, if (00000) then 110010100 else 110010100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- readCore(T);
-- L0771@010C C1BDDEFF000003000000.  readCore(T);
--  nWR = 1, nRD = 1, if (00000) then 110111101 else 110111101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 11, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- writeCore(T, same);
-- L0773@010E C1BCDE7F000003000000.  writeCore(T, same);
--  nWR = 1, nRD = 1, if (00000) then 110111100 else 110111100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 11, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 43;
-- L0780@0110 C1D3E9AB020000000000.  trace(from_microcode), directByte = 43;
...
-- traceString 42;
-- L0786@0112 C1D3E9AA020000000000.  trace(from_microcode), directByte = 42;
...
-- L0788@0114 C197CBFF702000000000.  XQhere <= T, readCore16(Prog_start);
...
-- L0789@0115 E771007F000000000000.  if R_IS_ZERO then NOPROG_ERR;
...
-- traceString 44;
-- L0796@0118 C1D3E9AC020000000000.  trace(from_microcode), directByte = 44;
...
-- L0797@0119 C1BADD53000008000000.stop_run:  directByte = 'S', outChar(from_microcode);
...
-- L0798@011A C1BADD54000008000000.  directByte = 'T', outChar(from_microcode);
...
-- L0799@011B C1BADD4F000008000000.  directByte = 'O', outChar(from_microcode);
...
-- L0800@011C C1BADD50000008000000.  directByte = 'P', outChar(from_microcode);
...
-- goto print_lino;
-- L0801@011D FE00C47F000000000000.  if false then continue else print_lino;
...
-- traceString 49;
-- L0806@011E C1D3E9B1020000000000.  trace(from_microcode), directByte = 49;
...
-- traceALU();
-- L0810@0122 C1CCE67F000000000000.  traceALU();
--  nWR = 1, nRD = 1, if (00000) then 111001100 else 111001100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- readCore(T);
-- L0819@0128 C1BDDEFF000003000000.u_peek8:  readCore(T);
--  nWR = 1, nRD = 1, if (00000) then 110111101 else 110111101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 11, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- readCore16(same);
-- L0823@012B C197CBFF000000000000.u_peek16:  readCore16(same);
--  nWR = 1, nRD = 1, if (00000) then 110010111 else 110010111, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- writeCore(T, from_SLo);
-- L0827@012E C1BCDE7F000003C00000.  writeCore(T, from_SLo);
--  nWR = 1, nRD = 1, if (00000) then 110111100 else 110111100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 11, MDR <= 110, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0831@0131 C1BCDE7F580003A00000.  writeCore(T, from_SHi), T <= inc;
...
-- writeCore(T, from_SLo);
-- L0832@0132 C1BCDE7F000003C00000.  writeCore(T, from_SLo);
--  nWR = 1, nRD = 1, if (00000) then 110111100 else 110111100, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 11, MDR <= 110, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 19;
-- L0842@0137 C1D3E993020000000000.  trace(from_microcode), directByte = 19;
...
-- L0843@0138 E37D007F000000000000.  if STACK_IS_EMPTY then RSTACK_ERR;
...
-- traceString 20;
-- L0849@013A C1D3E994020000000000.  trace(from_microcode), directByte = 20;
...
-- traceString 3;
-- L0850@013B C1D3E983020000000000.  trace(from_microcode), directByte = 3;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0000011, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0851@013C E17D007F000000000000.  if STACK_IS_FULL then RSTACK_ERR;
...
-- traceString 21;
-- L0857@013E C1D3E995020000000000.  trace(from_microcode), directByte = 21;
...
-- traceString 3;
-- L0858@013F C1D3E983020000000000.  trace(from_microcode), directByte = 3;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0000011, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 7;
-- L0864@0141 C1D3E987020000000000.  trace(from_microcode), directByte = 7;
...
-- traceGoto;
-- L0866@0143 C1D3E99E020000000000.br_exit:  trace(from_microcode), directByte = 30;
...
-- traceString 7;
-- L0872@0145 C1D3E987020000000000.  trace(from_microcode), directByte = 7;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0000111, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- traceString 17;
-- L0878@0147 C1D3E991020000000000.  trace(from_microcode), directByte = 17;
...
-- L0879@0148 C1B1D8FF080000040000.  T <= IL_PC, BP <= save, skipSpaces();
...
-- traceString 3;
-- L0880@0149 C1D3E983020000000000.bc_loop:  trace(from_microcode), directByte = 3;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0000011, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
329 => '1' & '1' & "00000" & O"723" & O"723" & "0000011" & "00000" & "01" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- readCore(BP);
-- L0881@014A C1BDDEFF000002000000.  readCore(BP);
--  nWR = 1, nRD = 1, if (00000) then 110111101 else 110111101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 10, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0882@014B E400A8FF000000000000.  if MDR_MATCHES_ILCODEBYTE then next else bc_exit;
...
-- L0883@014C C34E007F000000000000.  if ILCODEBYTE_BIT7 then bc_match;
...
-- L0884@014D FE00A4FF008000030000.  BP <= inc, IL_PC <= inc, if false then continue else bc_loop;
...
-- BP <= inc, IL_PC <= inc;
-- L0885@014E C000007F008000030000.bc_match:  BP <= inc, IL_PC <= inc;
...
-- traceBP();
-- L0889@0152 C1C6E37F000000000000.  traceBP();
--  nWR = 1, nRD = 1, if (00000) then 111000110 else 111000110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0890@0153 F577A1FF014000000000.  IL_PC <= pc_plus_off5, if OFF_IS_ZERO then SYNTAX_ERR else br_exit;
...
-- traceString 16;
-- L0895@0154 C1D3E990020000000000.  trace(from_microcode), directByte = 16;
...
-- skipSpaces();
-- L0896@0155 C1B1D8FF000000000000.  skipSpaces();
--  nWR = 1, nRD = 1, if (00000) then 110110001 else 110110001, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0897@0156 DF58007F000000800000.  MDR <= ToUpper, if MDR_IS_ALPHA then bv_exec;
...
-- IL_PC <= pc_plus_off5, if OFF_IS_ZERO then SYNTAX_ERR else br_exit;
-- L0898@0157 F577A1FF014000000000.  IL_PC <= pc_plus_off5, if OFF_IS_ZERO then SYNTAX_ERR else br_exit;
--  nWR = 1, nRD = 1, if (11010) then 101110111 else 101000011, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 101, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0899@0158 E17B007F500000000000.bv_exec:  T <= MDRx2, if STACK_IS_FULL then ESTACK_ERR;
...
-- L0900@0159 FE0004FF0000A0030000.  ExpStack <= push_TByte, BP <= inc, if false then continue else fetch;
...
-- traceString 14;
-- L0905@015A C1D3E98E020000000000.  trace(from_microcode), directByte = 14;
...
-- skipSpaces();
-- L0906@015B C1B1D8FF000000000000.  skipSpaces();
--  nWR = 1, nRD = 1, if (00000) then 110110001 else 110110001, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0907@015C DD61007F000000000040.  alu <= reset0, if MDR_IS_NUM then bn_loop;
...
-- L0908@015D F40D007F014000000000.  IL_PC <= pc_plus_off5, if OFF_IS_ZERO then badop;
...
-- traceY();
-- L0909@015E C1C9E4FF000000000000.bn_exit:  traceY();
...
-- traceGoto;
-- L0910@015F C1D3E99E020000000000.  trace(from_microcode), directByte = 30;
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 0011110, T <= 00000, DBGINDEX <= 01, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
351 => '1' & '1' & "00000" & O"723" & O"723" & "0011110" & "00000" & "01" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- goto fetch;
-- L0911@0160 FE0004FF000000000000.  if false then continue else fetch;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 000001001, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0912@0161 C000007F000000030400.bn_loop:  alu <= Yx10_plus_MDR, BP <= inc;
...
-- L0913@0162 EF75007F000000000000.  if ALU_OVERFLOW then OVERFLOW_ERR;
...
-- readCore(BP);
-- L0914@0163 C1BDDEFF000002000000.  readCore(BP);
--  nWR = 1, nRD = 1, if (00000) then 110111101 else 110111101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 10, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0915@0164 DD61007F000000000000.  if MDR_IS_NUM then bn_loop;
...
-- L0916@0165 E17B007F280000000000.  T <= from_YLo, if STACK_IS_FULL then ESTACK_ERR;
...
-- L0917@0166 FE00AF7F000080000000.  ExpStack <= push_TWord, if false then continue else bn_exit;
...
-- traceString 13;
-- L0922@0167 C1D3E98D020000000000.  trace(from_microcode), directByte = 13;
...
-- skipSpaces();
-- L0923@0168 C1B1D8FF000000000000.  skipSpaces();
--  nWR = 1, nRD = 1, if (00000) then 110110001 else 110110001, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0924@0169 CA09000D000000000000.  directByte = 0x0D, if MDR_EQU_DB then fetch;
...
-- IL_PC <= pc_plus_off5, if OFF_IS_ZERO then SYNTAX_ERR else br_exit;
-- L0925@016A F577A1FF014000000000.  IL_PC <= pc_plus_off5, if OFF_IS_ZERO then SYNTAX_ERR else br_exit;
--  nWR = 1, nRD = 1, if (11010) then 101110111 else 101000011, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 101, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0927@016B C1D3E9B7020000002000.BREAK:  gotChar = 1, trace(from_microcode), directByte = 55;
...
-- outBeep();
-- L0928@016C C1B5DAFF000000000000.  outBeep();
...
-- L0929@016D C1BADD42000008000000.  directByte = 'B', outChar(from_microcode);
...
-- L0930@016E C1BADD52000008000000.  directByte = 'R', outChar(from_microcode);
...
-- L0931@016F C1BADD4B000008000000.  directByte = 'K', outChar(from_microcode);
...
-- goto traceDetails;
-- L0932@0170 FE00C27F000000000000.  if false then continue else traceDetails;
...
-- traceString 50;
-- L0934@0171 C1D3E9B2020000000000.NOPROG_ERR:  trace(from_microcode), directByte = 50;
...
-- goto traceError;
-- L0935@0172 FE00C07F000000000000.  if false then continue else traceError;
...
-- traceString 57;
-- L0936@0173 C1D3E9B9020000000000.DIVBY0_ERR:  trace(from_microcode), directByte = 57;
...
-- goto traceError;
-- L0937@0174 FE00C07F000000000000.  if false then continue else traceError;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 110000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
372 => '1' & '1' & "11111" & O"000" & O"600" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 58;
-- L0938@0175 C1D3E9BA020000000000.OVERFLOW_ERR:  trace(from_microcode), directByte = 58;
...
-- goto traceError;
-- L0939@0176 FE00C07F000000000000.  if false then continue else traceError;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 110000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
374 => '1' & '1' & "11111" & O"000" & O"600" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 61;
-- L0940@0177 C1D3E9BD020000000000.SYNTAX_ERR:  trace(from_microcode), directByte = 61;
...
-- goto traceError;
-- L0941@0178 FE00C07F000000000000.  if false then continue else traceError;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 110000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
376 => '1' & '1' & "11111" & O"000" & O"600" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 62;
-- L0942@0179 C1D3E9BE020000000000.INTERNAL_ERR:  trace(from_microcode), directByte = 62;
...
-- goto traceError;
-- L0943@017A FE00C07F000000000000.  if false then continue else traceError;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 110000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
378 => '1' & '1' & "11111" & O"000" & O"600" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 60;
-- L0944@017B C1D3E9BC020000000000.ESTACK_ERR:  trace(from_microcode), directByte = 60;
...
-- goto traceError;
-- L0945@017C FE00C07F000000000000.  if false then continue else traceError;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 110000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
380 => '1' & '1' & "11111" & O"000" & O"600" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 59;
-- L0946@017D C1D3E9BB020000000000.RSTACK_ERR:  trace(from_microcode), directByte = 59;
...
-- goto traceError;
-- L0947@017E FE00C07F000000000000.  if false then continue else traceError;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 110000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
382 => '1' & '1' & "11111" & O"000" & O"600" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- traceString 54;
-- L0948@017F C1D3E9B6020000000000.BSTACK_ERR:  trace(from_microcode), directByte = 54;
...
-- outBeep();
-- L0949@0180 C1B5DAFF000000000000.traceError:  outBeep();
--  nWR = 1, nRD = 1, if (00000) then 110110101 else 110110101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0950@0181 C1BADD45000008000000.  directByte = 'E', outChar(from_microcode);
...
-- directByte = 'R', outChar(from_microcode);
-- L0951@0182 C1BADD52000008000000.  directByte = 'R', outChar(from_microcode);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 1010010, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 010, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
386 => '1' & '1' & "00000" & O"672" & O"672" & "1010010" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"2" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- directByte = 'R', outChar(from_microcode);
-- L0952@0183 C1BADD52000008000000.  directByte = 'R', outChar(from_microcode);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 1010010, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 010, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0953@0184 C1BADD23080008000000.traceDetails:  directByte = '#', outChar(from_microcode), T <= IL_PC;
...
-- L0956@0187 F600C8FF000000000000.  if IS_RUNMODE then next else err_done;
...
-- directByte = ' ', outChar(from_microcode);
-- L0957@0188 C1BADD20000008000000.print_lino:  directByte = ' ', outChar(from_microcode);
--  nWR = 1, nRD = 1, if (00000) then 110111010 else 110111010, directByte = 0100000, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 010, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0958@0189 C1BADD41000008000000.  directByte = 'A', outChar(from_microcode);
...
-- L0959@018A C1BADD54000008000500.  directByte = 'T', outChar(from_microcode), alu <= S_fromLino;
...
-- L0960@018B C1BADD20800008000000.  directByte = ' ', outChar(from_microcode), T <= from_S;
...
-- printDecR(R_fromT);
-- L0961@018C C1A3D1FF0000000004C0.  printDecR(R_fromT);
--  nWR = 1, nRD = 1, if (00000) then 110100011 else 110100011, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 10011, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0962@018D C1BADD20C80008000000.  directByte = ' ', outChar(from_microcode), T <= fromTicks;
...
-- printDecR(R_fromT);
-- L0963@018E C1A3D1FF0000000004C0.  printDecR(R_fromT);
--  nWR = 1, nRD = 1, if (00000) then 110100011 else 110100011, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 10011, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0964@018F C1BADD2E980008000000.  directByte = ' C1BADD2E980008000000.', outChar(from_microcode), T <= recall;
...
-- goto WarmStart;
-- L0968@0193 FE00037F000000000000.  if false then continue else WarmStart;
--  nWR = 1, nRD = 1, if (11111) then 000000000 else 000000110, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
403 => '1' & '1' & "11111" & O"000" & O"006" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- readCore(T);
-- L0970@0194 C1BDDEFF000003000000.findNextCR:  readCore(T);
--  nWR = 1, nRD = 1, if (00000) then 110111101 else 110111101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 11, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L0971@0195 CA02000D000000000000.  directByte = 0x0D, if MDR_EQU_DB then return;
...
-- L0972@0196 CB79CA00580000000000.  T <= inc, directByte = 0x00, if MDR_EQU_DB then INTERNAL_ERR else findNextCR;
...
-- L0977@019A C002007F580000000440.  alu <= Rx256_plus_MDR, T <= inc, if true then return else continue;
...
-- L0979@019B C1BCDE7F580003400000.write2Nulls:  writeCore(T, zero), T <= inc;
...
-- writeCore(T, zero);
-- L0980@019C C1BCDE7F000003400000.  writeCore(T, zero);
...
-- L0987@01A1 C002007F0000C0000100.  alu <= S_fromStack, ExpStack <= pop2, if true then return else continue;
...
-- alu <= R_fromStack, ExpStack <= pop2;
-- L0990@01A2 C000007F0000C00000C0.printDec:  alu <= R_fromStack, ExpStack <= pop2;
--  nWR = 1, nRD = 1, if (00000) then 000000000 else 000000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 110, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00011, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
418 => '1' & '1' & "00000" & O"000" & O"000" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"6" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00011" & '0' & '0' & '0' & '0' & '0' & '0',

-- alu <= bcd_start;
-- L0992@01A3 C000007F000000000280.printDecR:  alu <= bcd_start;
...
-- L0993@01A4 EC0000FF0000000002C0.  alu <= bcd_next, if ALU_READY then next else repeat;
...
-- L0994@01A5 F000D3FF000000000000.  if ALU_SIGN then next else printY;
...
-- directByte = '-', outChar(from_microcode);
-- L0995@01A6 C1BADD2D000008000000.  directByte = '-', outChar(from_microcode);
...
-- L0996@01A7 C1AFD7FF000018000000.printY:  outNZChar(from_YtoAlphaZ);
...
-- L1003@01AE FE00DD7F000014000000.  CHAROUT <= from_YtoAlpha, if false then continue else outChar;
...
-- L1005@01AF C1BADD7F000018000000.outNZChar:  outChar(from_YtoAlphaZ);
...
-- alu <= Yx16, back;
-- L1006@01B0 C002007F000000000240.out_skip:  alu <= Yx16, if true then return else continue;
...
-- readCore(BP);
-- L1008@01B1 C1BDDEFF000002000000.skipSpaces:  readCore(BP);
--  nWR = 1, nRD = 1, if (00000) then 110111101 else 110111101, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 10, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L1009@01B2 CBB40020000000000000.  directByte = ' ', if MDR_EQU_DB then skipSp;
...
-- L1010@01B3 CBB40109000000000000.  directByte = 0x09, if MDR_EQU_DB then skipSp else return;
...
-- L1011@01B4 FE00D8FF000000030000.skipSp:  BP <= inc, if false then continue else skipSpaces;
...
-- L1015@01B7 FE00DD07000008000000.  directByte = 0x07, CHAROUT <= from_microcode, if false then continue else outChar;
...
-- L1017@01B8 C1BADD0D000008000000.outCRLF:  directByte = 0x0D, outChar(from_microcode);
...
-- L1018@01B9 C000000A000008000000.  directByte = 0x0A, CHAROUT <= from_microcode;
...
-- L1019@01BA C40000FF000000000000.outChar:  if CHAROUT_READY then next else repeat;
...
-- L1020@01BB C40200FF000000000000.  if CHAROUT_READY then return else repeat;
...
-- L1022@01BC 4C01017F000000000000.writeCore:  nWR = 0, if nBUSACK then repeat else return;
...
-- L1024@01BD 8C01007F000000000000.readCore:  nRD = 0, if nBUSACK then repeat else next;
...
-- L1025@01BE 8002007F000000200000.  nRD = 0, MDR <= from_Bus, if true then return else continue;
...
-- L1029@01BF C1D3E9FF060000080000.dump_input:  InlEnd <= InLine_start, trace(crlf);
...
-- readCore(InlEnd);
-- L1030@01C0 C1BDDEFF000001000000.dump_inlp:  readCore(InlEnd);
...
-- L1031@01C1 C1D3E989020000000000.  directByte = 9, trace(from_microcode);
...
-- L1032@01C2 CBC40000000000000000.  directByte = 0x00, if MDR_EQU_DB then dump_inex;
...
-- L1033@01C3 FE00E07F000000100000.  InlEnd <= inc, if false then continue else dump_inlp;
...
-- trace(crlf);
-- L1034@01C4 C1D3E9FF060000000000.dump_inex:  trace(crlf);
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 1111111, T <= 00000, DBGINDEX <= 11, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
452 => '1' & '1' & "00000" & O"723" & O"723" & "1111111" & "00000" & "11" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- back;
-- L1035@01C5 C002007F000000000000.  if true then return else continue;
--  nWR = 1, nRD = 1, if (00000) then 000000010 else 000000000, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
...
-- L1037@01C6 C000007F680080000000.traceBP:  ExpStack <= push_TWord, T <= BP;
...
-- traceString 33;
-- L1038@01C7 C1D3E9A1020000000000.  trace(from_microcode), directByte = 33;
...
-- L1039@01C8 C002007F2000C0000000.  T <= ExpStack, ExpStack <= pop2, if true then return else continue;
...
-- L1041@01C9 C000007F280080000000.traceY:  ExpStack <= push_TWord, T <= from_YLo;
...
-- traceString 32;
-- L1042@01CA C1D3E9A0020000000000.  trace(from_microcode), directByte = 32;
...
-- T <= ExpStack, ExpStack <= pop2, back;
-- L1043@01CB C002007F2000C0000000.  T <= ExpStack, ExpStack <= pop2, if true then return else continue;
--  nWR = 1, nRD = 1, if (00000) then 000000010 else 000000000, directByte = 1111111, T <= 00100, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 110, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
459 => '1' & '1' & "00000" & O"002" & O"000" & "1111111" & "00100" & "00" & O"0" & '0' & '0' & "00" & "00" & O"6" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- trace(crlf);
-- L1045@01CC C1D3E9FF060000000000.traceALU:  trace(crlf);
--  nWR = 1, nRD = 1, if (00000) then 111010011 else 111010011, directByte = 1111111, T <= 00000, DBGINDEX <= 11, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
460 => '1' & '1' & "00000" & O"723" & O"723" & "1111111" & "00000" & "11" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- T <= save, traceT;
-- L1046@01CD C1D3E9B4920000000000.  T <= save, trace(from_microcode), directByte = 52;
...
-- L1047@01CE C1D3E9B4820000000000.  T <= from_S, trace(from_microcode), directByte = 52;
...
-- L1048@01CF C1D3E9B48A0000000000.  T <= from_R, trace(from_microcode), directByte = 52;
...
-- L1049@01D0 C1D3E9B5320000000000.  T <= from_YHi, trace(from_microcode), directByte = 53;
...
-- L1050@01D1 C1D3E9B42A0000000000.  T <= from_YLo, trace(from_microcode), directByte = 52;
...
-- L1051@01D2 C000007F9E0000000000.  T <= recall, DBGINDEX <= crlf;
...
-- L1052@01D3 C80000FF000000000000.trace:  if DBG_READY then next else repeat;
...
-- if DBG_READY then next else repeat;
-- L1053@01D4 C80000FF000000000000.  if DBG_READY then next else repeat;
--  nWR = 1, nRD = 1, if (00100) then 000000000 else 000000001, directByte = 1111111, T <= 00000, DBGINDEX <= 00, IL_PC <= 000, XQhere <= 0, IL_OP <= 0, RetStack <= 00, BasStack <= 00, ExpStack <= 000, CHAROUT <= 000, MAR <= 00, MDR <= 000, InlEnd <= 00, BP <= 000, SvPt <= 00, gotChar = 0, Vars <= 00, alu <= 00000, Lino <= 0, BE <= 0, LS <= 0, LE <= 0, PrgEnd <= 0, dummy = 0;
468 => '1' & '1' & "00100" & O"000" & O"001" & "1111111" & "00000" & "00" & O"0" & '0' & '0' & "00" & "00" & O"0" & O"0" & "00" & O"0" & "00" & O"0" & "00" & '0' & "00" & "00000" & '0' & '0' & '0' & '0' & '0' & '0',

-- DBGINDEX <= zero, back;
-- L1054@01D5 C002007F040000000000.  DBGINDEX <= zero, if true then return else continue;
